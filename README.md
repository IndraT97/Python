...
Welcome to my Python Portfolio repository!! 🚀
 ...
 This repository is a comprehensive collection of solutions to problems from various platforms, and advanced projects, all designed to demonstrate my proficiency in Python. 📊
...
1. **Clone the repository**:
    ...
    ```sh
    git clone https://github.com/IndraT97/Python.git
    ```
